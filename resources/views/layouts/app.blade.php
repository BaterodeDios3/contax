...
<head>
    ...
    <title>@yield('title')ContaX</title>
            ...
            <div class="sidebar-wrapper scrollbar scrollbar-inner">
                <div class="sidebar-content">
                    ...
                    <ul class="nav nav-primary">
                        ...
                        @endcan
                        @canany(['creditos.autorizados','creditos.rechazados','creditos.pendientes'])
                        <li class="nav-item">
                            ...
                            <div class="collapse" id="creditos">
                                <ul class="nav nav-collapse">
                                    @can('creditos.autorizados')
                                    <li>
                                        <a href="{{ route('creditos.autorizados') }}">
                                            <span class="sub-item">Autorizados</span>
                                        </a>
                                    </li>
                                    @endcan
                                    @can('creditos.rechazados')
                                    <li>
                                        <a href="{{ route('creditos.rechazados') }}">
                                            <span class="sub-item">Rechazados</span>
                                        </a>
                                    </li>
                                    @endcan
                                    @can('creditos.pendientes')
                                    <li>
                                        <a href="{{ route('creditos.pendientes') }}">
        ...
        <div class="main-panel">
            ...
            <footer class="footer">
                <div class="container-fluid">
                    ...
                    ContaX <i class="far fa-copyright"></i> {{date('Y')}}
                    </div>
                </div>
            </footer>
        </div>
